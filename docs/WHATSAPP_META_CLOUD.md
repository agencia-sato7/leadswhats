...
## 4. Passo a Passo de Cadastro do Webhook na Meta
...
- **Sem Validação X-Hub-Signature**: Nesta fase do MVP, a verificação de assinatura SHA256 do payload no cabeçalho do webhook da Meta não está habilitada.
